...
export function TopResearch() {
  return (
    <Section className="mt-20 sm:mt-28">
      <div className="mb-8">
        <h2 className="text-3xl font-semibold text-ink">Top Research</h2>
      ...
      <div className="flex gap-6 overflow-x-auto py-6 -mx-4 px-4 sm:mx-0 sm:px-0 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        {researchProjects.map((project, index) => (
          <motion.div
            ...
            className="group relative flex w-[85vw] sm:w-[350px] shrink-0 snap-center flex-col overflow-hidden rounded-2xl border border-[rgb(var(--ink-muted)/0.12)] bg-surface-elevated/40 backdrop-blur-sm transition-all hover:border-accent/30 hover:-translate-y-1"
          >
            ...
            <div className="relative flex flex-1 flex-col justify-between p-6 -mt-20 z-10">
              <div>
                <span className="inline-block rounded-full bg-[rgb(var(--accent)/0.2)] px-3 py-1 text-xs font-semibold text-accent backdrop-blur-sm shadow-sm">
                  {project.type}
                </span>
        ...
        <motion.div
          ...
          className="flex w-[85vw] sm:w-[300px] shrink-0 snap-center items-center justify-center rounded-2xl border-2 border-dashed border-[rgb(var(--ink-muted)/0.15)] bg-surface-elevated/10 p-6 transition-colors hover:border-accent/40 hover:bg-surface-elevated/20"
        >
          <div className="text-center">
            ...
            <h3 className="mb-5 text-lg font-semibold text-ink">Want to see more?</h3>
